...
<div class="preloader">
    <div class="loader">
        ...
        <div class="indicator"> 
            <!-- Substitua o SVG pelo seu novo ícone IcoFont -->
            <i class="icofont-medical-sign-alt" style="font-size: 50px; color: #3498db;"></i>
        </div>
    </div>
</div>
<!-- End Preloader -->
					...
					<div class="inner">
						<div class="row">
							<div class="col-lg-3 col-md-3 col-12">
								<!-- Start Logo -->
								<div class="logo">
									<a href="index.html"><img src="img/logo_serconeo.png" alt="#"></a>
								</div>
								<!-- End Logo -->
								<!-- Mobile Nav -->
